...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    #
    # inject(0) passes 0 to sum and the { block } is executed
    # for all the elements of array passing item one by one
    # The return value of the block will go into sum on the next
    # iteration
    #
  end
