...
class AboutHashes < Neo::Koan
  ...
  def test_accessing_hashes_with_fetch
    ...
    # Ans: By default, using #[] will retrieve the hash value if it exists, and return nil if it doesn't exist *.
  ...
  def test_changing_hashes
    ...
    # Ans :
    # Because you can't use something like this:
  ...
  def test_default_value
    ...
    hash2 = Hash.new("dos")   #"dos" will become the default value of the hash
    hash2[:one] = 1
